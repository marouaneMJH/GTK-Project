...
typedef struct {
    /* Text Content */
    gchar label_text[MAX_TEXT_LABEL];          // Pointer for dynamic text allocation
    ...
    gchar text_color[MAX_COLOR];          // Text color 
    gchar background_color[MAX_COLOR];    // Background color 
