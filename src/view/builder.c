...
static void exit_func(GtkWidget *widget, gpointer data)
{
...
static void display_dialog(GtkWidget *widget, gpointer data)
{
...
View *read_button_tag(FILE *index, View *parent_view, gboolean is_relative_container)
{
    ...
    if (view_config->onclick[0] != '\0')
    {
        ...
        else if (g_strcmp0(view_config->onclick, "exit") == 0)
            g_signal_connect(G_OBJECT(button_widget), "clicked", G_CALLBACK(exit_func), NULL);
    }
